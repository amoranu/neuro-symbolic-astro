...
_R_FATHER_9H_RESIDENT = CFRuleSpec(
    rule=_r(
        "parashari.father.father_9h_resident_dasha.cf13",
...
_R_FATHER_9TH_LORD_ONLY = CFRuleSpec(
    rule=_r(
        "parashari.father.father_9th_lord_only_dasha.cf13",
...
_R_FATHER_LAGNA_LORD_AD = CFRuleSpec(
    rule=_r(
        "parashari.father.lagna_lord_ad_under_malefic_md.cf12",
...
_R_FATHER_8TH_LORD_AD = CFRuleSpec(
    rule=_r(
        "parashari.father.eighth_lord_ad_under_malefic_md.cf13",
        base_cf=-0.30, primary_planet="Sun",
...
RULES_V13: List[CFRuleSpec] = [
    ...
    CFRuleSpec(
        rule=_r(
            "parashari.father.sun_dusthana_malefic_md.cf12",
